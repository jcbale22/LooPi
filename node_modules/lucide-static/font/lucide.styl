...
$icon-a-arrow-down = '\e58a'
$icon-a-arrow-up = '\e58b'
$icon-a-large-small = '\e58c'
$icon-accessibility = '\e297'
$icon-activity = '\e038'
$icon-air-vent = '\e351'
$icon-airplay = '\e039'
$icon-alarm-clock-check = '\e1ec'
$icon-alarm-clock-minus = '\e1ed'
$icon-alarm-clock-off = '\e23b'
$icon-alarm-clock-plus = '\e1ee'
$icon-alarm-clock = '\e03a'
$icon-alarm-smoke = '\e580'
$icon-album = '\e03b'
$icon-align-center-horizontal = '\e26c'
$icon-align-center-vertical = '\e26d'
$icon-align-center = '\e03c'
$icon-align-end-horizontal = '\e26e'
$icon-align-end-vertical = '\e26f'
...
$icon-align-horizontal-justify-center = '\e272'
$icon-align-horizontal-justify-end = '\e273'
$icon-align-horizontal-justify-start = '\e274'
$icon-align-horizontal-space-around = '\e275'
$icon-align-horizontal-space-between = '\e276'
$icon-align-justify = '\e040'
$icon-align-left = '\e041'
$icon-align-right = '\e042'
$icon-align-start-horizontal = '\e270'
$icon-align-start-vertical = '\e271'
$icon-align-vertical-distribute-center = '\e27e'
$icon-align-vertical-distribute-end = '\e27f'
$icon-align-vertical-distribute-start = '\e280'
$icon-align-vertical-justify-center = '\e277'
$icon-align-vertical-justify-end = '\e278'
$icon-align-vertical-justify-start = '\e279'
$icon-align-vertical-space-around = '\e27a'
$icon-align-vertical-space-between = '\e27b'
$icon-ambulance = '\e5c0'
$icon-ampersand = '\e4a1'
$icon-ampersands = '\e4a2'
$icon-amphora = '\e620'
$icon-anchor = '\e043'
$icon-angry = '\e2fc'
$icon-annoyed = '\e2fd'
...
$icon-anvil = '\e585'
$icon-aperture = '\e044'
$icon-app-window-mac = '\e5d7'
$icon-app-window = '\e42b'
$icon-apple = '\e352'
$icon-archive-restore = '\e2cd'
$icon-archive-x = '\e511'
$icon-archive = '\e045'
$icon-armchair = '\e2c0'
$icon-arrow-big-down-dash = '\e422'
$icon-arrow-big-down = '\e1e1'
$icon-arrow-big-left-dash = '\e423'
$icon-arrow-big-left = '\e1e2'
$icon-arrow-big-right-dash = '\e424'
$icon-arrow-big-right = '\e1e3'
$icon-arrow-big-up-dash = '\e425'
$icon-arrow-big-up = '\e1e4'
$icon-arrow-down-0-1 = '\e418'
$icon-arrow-down-1-0 = '\e419'
$icon-arrow-down-a-z = '\e41a'
$icon-arrow-down-from-line = '\e459'
$icon-arrow-down-left = '\e047'
$icon-arrow-down-narrow-wide = '\e048'
$icon-arrow-down-right = '\e049'
$icon-arrow-down-to-dot = '\e452'
$icon-arrow-down-to-line = '\e45a'
$icon-arrow-down-up = '\e04a'
$icon-arrow-down-wide-narrow = '\e04b'
$icon-arrow-down-z-a = '\e41b'
$icon-arrow-down = '\e046'
$icon-arrow-left-from-line = '\e45b'
$icon-arrow-left-right = '\e24a'
$icon-arrow-left-to-line = '\e45c'
$icon-arrow-left = '\e04c'
$icon-arrow-right-from-line = '\e45d'
$icon-arrow-right-left = '\e41c'
$icon-arrow-right-to-line = '\e45e'
$icon-arrow-right = '\e04d'
$icon-arrow-up-0-1 = '\e41d'
$icon-arrow-up-1-0 = '\e41e'
$icon-arrow-up-a-z = '\e41f'
$icon-arrow-up-down = '\e381'
$icon-arrow-up-from-dot = '\e453'
$icon-arrow-up-from-line = '\e45f'
$icon-arrow-up-left = '\e04f'
$icon-arrow-up-narrow-wide = '\e050'
$icon-arrow-up-right = '\e051'
$icon-arrow-up-to-line = '\e460'
$icon-arrow-up-wide-narrow = '\e420'
$icon-arrow-up-z-a = '\e421'
$icon-arrow-up = '\e04e'
$icon-arrows-up-from-line = '\e4d9'
$icon-asterisk = '\e1ef'
$icon-at-sign = '\e052'
$icon-atom = '\e3db'
$icon-audio-lines = '\e55f'
$icon-audio-waveform = '\e560'
$icon-award = '\e053'
$icon-axe = '\e054'
$icon-axis-3d = '\e2fe'
$icon-baby = '\e2ce'
$icon-backpack = '\e2c8'
$icon-badge-alert = '\e47a'
$icon-badge-cent = '\e514'
$icon-badge-check = '\e241'
$icon-badge-dollar-sign = '\e47b'
$icon-badge-euro = '\e515'
$icon-badge-indian-rupee = '\e516'
$icon-badge-info = '\e47c'
$icon-badge-japanese-yen = '\e517'
$icon-badge-minus = '\e47d'
$icon-badge-percent = '\e47e'
$icon-badge-plus = '\e47f'
$icon-badge-pound-sterling = '\e518'
$icon-badge-question-mark = '\e480'
$icon-badge-russian-ruble = '\e519'
$icon-badge-swiss-franc = '\e51a'
$icon-badge-x = '\e481'
$icon-badge = '\e479'
$icon-baggage-claim = '\e2c9'
$icon-ban = '\e055'
$icon-banana = '\e353'
$icon-bandage = '\e622'
$icon-banknote-arrow-down = '\e651'
$icon-banknote-arrow-up = '\e652'
$icon-banknote-x = '\e653'
$icon-banknote = '\e056'
$icon-barcode = '\e538'
$icon-barrel = '\e67a'
$icon-baseline = '\e285'
...
$icon-battery-plus = '\e643'
$icon-battery-warning = '\e3b0'
$icon-battery = '\e057'
$icon-beaker = '\e05c'
$icon-bean-off = '\e394'
$icon-bean = '\e393'
$icon-bed-double = '\e2c2'
$icon-bed-single = '\e2c3'
$icon-bed = '\e2c1'
$icon-beef = '\e3a9'
$icon-beer-off = '\e5de'
$icon-beer = '\e2cf'
$icon-bell-dot = '\e430'
$icon-bell-electric = '\e581'
$icon-bell-minus = '\e1f0'
$icon-bell-off = '\e05e'
$icon-bell-plus = '\e1f1'
$icon-bell-ring = '\e224'
$icon-bell = '\e05d'
$icon-between-horizontal-end = '\e596'
$icon-between-horizontal-start = '\e597'
$icon-between-vertical-end = '\e598'
$icon-between-vertical-start = '\e599'
$icon-biceps-flexed = '\e5f0'
$icon-bike = '\e1d2'
$icon-binary = '\e1f2'
$icon-binoculars = '\e626'
$icon-biohazard = '\e446'
$icon-bird = '\e3c9'
$icon-bitcoin = '\e05f'
$icon-blend = '\e5a1'
$icon-blinds = '\e3c4'
$icon-blocks = '\e4ff'
$icon-bluetooth-connected = '\e1b8'
$icon-bluetooth-off = '\e1b9'
$icon-bluetooth-searching = '\e1ba'
$icon-bluetooth = '\e060'
$icon-bold = '\e061'
$icon-bolt = '\e591'
$icon-bomb = '\e2ff'
$icon-bone = '\e35c'
$icon-book-a = '\e549'
$icon-book-alert = '\e677'
$icon-book-audio = '\e54a'
$icon-book-check = '\e54b'
$icon-book-copy = '\e3f1'
$icon-book-dashed = '\e3f2'
$icon-book-down = '\e3f3'
$icon-book-headphones = '\e54c'
$icon-book-heart = '\e54d'
$icon-book-image = '\e54e'
$icon-book-key = '\e3f4'
$icon-book-lock = '\e3f5'
$icon-book-marked = '\e3f6'
$icon-book-minus = '\e3f7'
$icon-book-open-check = '\e385'
$icon-book-open-text = '\e54f'
$icon-book-open = '\e063'
$icon-book-plus = '\e3f8'
$icon-book-text = '\e550'
$icon-book-type = '\e551'
...
$icon-book-x = '\e3fa'
$icon-book = '\e062'
$icon-bookmark-check = '\e524'
$icon-bookmark-minus = '\e23c'
$icon-bookmark-plus = '\e23d'
$icon-bookmark-x = '\e525'
$icon-bookmark = '\e064'
$icon-boom-box = '\e4f3'
$icon-bot-message-square = '\e5d3'
$icon-bot-off = '\e5e5'
$icon-bot = '\e1bb'
$icon-bow-arrow = '\e663'
$icon-box = '\e065'
...
$icon-braces = '\e36e'
$icon-brackets = '\e448'
$icon-brain-circuit = '\e3cb'
$icon-brain-cog = '\e3cc'
$icon-brain = '\e3ca'
$icon-brick-wall-fire = '\e658'
$icon-brick-wall = '\e586'
$icon-briefcase-business = '\e5da'
$icon-briefcase-conveyor-belt = '\e630'
$icon-briefcase-medical = '\e5db'
$icon-briefcase = '\e066'
$icon-bring-to-front = '\e4f4'
$icon-brush-cleaning = '\e66b'
$icon-brush = '\e1d3'
$icon-bubbles = '\e659'
$icon-bug-off = '\e512'
$icon-bug-play = '\e513'
$icon-bug = '\e20c'
$icon-building-2 = '\e290'
$icon-building = '\e1cc'
$icon-bus-front = '\e500'
$icon-bus = '\e1d4'
$icon-cable-car = '\e501'
$icon-cable = '\e4e8'
$icon-cake-slice = '\e4be'
$icon-cake = '\e348'
$icon-calculator = '\e1bc'
$icon-calendar-1 = '\e635'
$icon-calendar-arrow-down = '\e603'
$icon-calendar-arrow-up = '\e604'
$icon-calendar-check-2 = '\e2b8'
$icon-calendar-check = '\e2b7'
$icon-calendar-clock = '\e304'
$icon-calendar-cog = '\e5f2'
$icon-calendar-days = '\e2b9'
$icon-calendar-fold = '\e5b9'
$icon-calendar-heart = '\e305'
$icon-calendar-minus-2 = '\e5ba'
$icon-calendar-minus = '\e2ba'
$icon-calendar-off = '\e2bb'
$icon-calendar-plus-2 = '\e5bb'
$icon-calendar-plus = '\e2bc'
$icon-calendar-range = '\e2bd'
$icon-calendar-search = '\e306'
$icon-calendar-sync = '\e63b'
$icon-calendar-x-2 = '\e2bf'
$icon-calendar-x = '\e2be'
$icon-calendar = '\e067'
$icon-camera-off = '\e069'
$icon-camera = '\e068'
$icon-candy-cane = '\e4bf'
$icon-candy-off = '\e396'
$icon-candy = '\e395'
$icon-cannabis = '\e5d9'
$icon-captions-off = '\e5c6'
$icon-captions = '\e3a8'
$icon-car-front = '\e502'
$icon-car-taxi-front = '\e503'
$icon-car = '\e1d5'
$icon-caravan = '\e53e'
$icon-card-sim = '\e676'
$icon-carrot = '\e25a'
$icon-case-lower = '\e3dc'
$icon-case-sensitive = '\e3dd'
$icon-case-upper = '\e3de'
$icon-cassette-tape = '\e4cf'
$icon-cast = '\e06a'
$icon-castle = '\e3e4'
$icon-cat = '\e390'
$icon-cctv = '\e582'
$icon-chart-area = '\e4d8'
$icon-chart-bar-big = '\e4ac'
$icon-chart-bar-decreasing = '\e60c'
$icon-chart-bar-increasing = '\e60d'
$icon-chart-bar-stacked = '\e60e'
$icon-chart-bar = '\e2a2'
$icon-chart-candlestick = '\e4ad'
$icon-chart-column-big = '\e4ae'
$icon-chart-column-decreasing = '\e06b'
$icon-chart-column-increasing = '\e2a4'
$icon-chart-column-stacked = '\e60f'
$icon-chart-column = '\e2a3'
$icon-chart-gantt = '\e629'
$icon-chart-line = '\e2a5'
$icon-chart-network = '\e610'
$icon-chart-no-axes-column-decreasing = '\e06d'
$icon-chart-no-axes-column-increasing = '\e06e'
$icon-chart-no-axes-column = '\e06c'
$icon-chart-no-axes-combined = '\e611'
$icon-chart-no-axes-gantt = '\e4c9'
$icon-chart-pie = '\e06f'
$icon-chart-scatter = '\e48f'
$icon-chart-spline = '\e612'
$icon-check-check = '\e392'
$icon-check-line = '\e670'
$icon-check = '\e070'
$icon-chef-hat = '\e2ac'
$icon-cherry = '\e354'
$icon-chevron-down = '\e071'
$icon-chevron-first = '\e243'
$icon-chevron-last = '\e244'
$icon-chevron-left = '\e072'
$icon-chevron-right = '\e073'
$icon-chevron-up = '\e074'
$icon-chevrons-down-up = '\e228'
$icon-chevrons-down = '\e075'
$icon-chevrons-left-right-ellipsis = '\e624'
$icon-chevrons-left-right = '\e293'
$icon-chevrons-left = '\e076'
$icon-chevrons-right-left = '\e294'
$icon-chevrons-right = '\e077'
$icon-chevrons-up-down = '\e211'
$icon-chevrons-up = '\e078'
$icon-chrome = '\e079'
$icon-church = '\e3e5'
$icon-cigarette-off = '\e2c7'
$icon-cigarette = '\e2c6'
$icon-circle-alert = '\e07b'
$icon-circle-arrow-down = '\e07c'
$icon-circle-arrow-left = '\e07d'
$icon-circle-arrow-out-down-left = '\e3fc'
$icon-circle-arrow-out-down-right = '\e3fd'
$icon-circle-arrow-out-up-left = '\e3fe'
$icon-circle-arrow-out-up-right = '\e3ff'
$icon-circle-arrow-right = '\e07e'
$icon-circle-arrow-up = '\e07f'
$icon-circle-check-big = '\e080'
$icon-circle-check = '\e226'
$icon-circle-chevron-down = '\e4e2'
$icon-circle-chevron-left = '\e4e3'
$icon-circle-chevron-right = '\e4e4'
$icon-circle-chevron-up = '\e4e5'
$icon-circle-dashed = '\e4b5'
$icon-circle-divide = '\e081'
$icon-circle-dollar-sign = '\e482'
$icon-circle-dot-dashed = '\e4b6'
$icon-circle-dot = '\e349'
$icon-circle-ellipsis = '\e34a'
$icon-circle-equal = '\e405'
$icon-circle-fading-arrow-up = '\e61d'
$icon-circle-fading-plus = '\e5c1'
$icon-circle-gauge = '\e4e6'
$icon-circle-minus = '\e082'
$icon-circle-off = '\e406'
$icon-circle-parking-off = '\e3ce'
$icon-circle-parking = '\e3cd'
$icon-circle-pause = '\e083'
$icon-circle-percent = '\e51f'
$icon-circle-play = '\e084'
$icon-circle-plus = '\e085'
$icon-circle-pound-sterling = '\e672'
$icon-circle-power = '\e555'
$icon-circle-question-mark = '\e086'
$icon-circle-slash-2 = '\e213'
$icon-circle-slash = '\e407'
$icon-circle-small = '\e645'
$icon-circle-stop = '\e087'
$icon-circle-user-round = '\e467'
$icon-circle-user = '\e466'
$icon-circle-x = '\e088'
$icon-circle = '\e07a'
$icon-circuit-board = '\e408'
$icon-citrus = '\e379'
$icon-clapperboard = '\e29b'
$icon-clipboard-check = '\e219'
$icon-clipboard-copy = '\e225'
$icon-clipboard-list = '\e08a'
$icon-clipboard-minus = '\e5c3'
$icon-clipboard-paste = '\e3ec'
$icon-clipboard-pen-line = '\e308'
$icon-clipboard-pen = '\e307'
$icon-clipboard-plus = '\e5c4'
$icon-clipboard-type = '\e309'
$icon-clipboard-x = '\e222'
$icon-clipboard = '\e089'
$icon-clock-1 = '\e24b'
$icon-clock-10 = '\e24c'
$icon-clock-11 = '\e24d'
...
$icon-clock-8 = '\e255'
$icon-clock-9 = '\e256'
$icon-clock-alert = '\e62f'
$icon-clock-arrow-down = '\e605'
$icon-clock-arrow-up = '\e606'
$icon-clock-fading = '\e64f'
$icon-clock-plus = '\e66c'
$icon-clock = '\e08b'
$icon-cloud-alert = '\e638'
$icon-cloud-check = '\e673'
$icon-cloud-cog = '\e30a'
...
$icon-cloud-moon-rain = '\e2fa'
$icon-cloud-moon = '\e215'
$icon-cloud-off = '\e091'
$icon-cloud-rain-wind = '\e093'
$icon-cloud-rain = '\e092'
$icon-cloud-snow = '\e094'
$icon-cloud-sun-rain = '\e2fb'
$icon-cloud-sun = '\e216'
...
$icon-component = '\e2ad'
$icon-computer = '\e4e9'
$icon-concierge-bell = '\e37c'
$icon-cone = '\e528'
$icon-construction = '\e3b8'
$icon-contact-round = '\e468'
$icon-contact = '\e0a0'
$icon-container = '\e4da'
$icon-contrast = '\e0a1'
$icon-cookie = '\e26b'
$icon-cooking-pot = '\e589'
$icon-copy-check = '\e400'
$icon-copy-minus = '\e401'
$icon-copy-plus = '\e402'
$icon-copy-slash = '\e403'
$icon-copy-x = '\e404'
$icon-copy = '\e0a2'
$icon-copyleft = '\e0a3'
$icon-copyright = '\e0a4'
...
$icon-cylinder = '\e52a'
$icon-dam = '\e60b'
$icon-database-backup = '\e3af'
$icon-database-zap = '\e510'
$icon-database = '\e0b1'
$icon-decimals-arrow-left = '\e661'
$icon-decimals-arrow-right = '\e662'
$icon-delete = '\e0b2'
$icon-dessert = '\e4c0'
$icon-diameter = '\e52b'
$icon-diamond-minus = '\e5e6'
$icon-diamond-percent = '\e520'
$icon-diamond-plus = '\e5e7'
$icon-diamond = '\e2d2'
$icon-dice-1 = '\e287'
$icon-dice-2 = '\e288'
$icon-dice-3 = '\e289'
...
$icon-donut = '\e4c1'
$icon-door-closed-locked = '\e669'
$icon-door-closed = '\e3d9'
$icon-door-open = '\e3da'
$icon-dot = '\e454'
$icon-download = '\e0b6'
$icon-drafting-compass = '\e52c'
$icon-drama = '\e526'
$icon-dribbble = '\e0b7'
$icon-drill = '\e592'
$icon-drone = '\e67b'
$icon-droplet-off = '\e63d'
$icon-droplet = '\e0b8'
$icon-droplets = '\e0b9'
$icon-drum = '\e562'
$icon-drumstick = '\e25b'
...
$icon-ellipsis = '\e0ba'
$icon-equal-approximately = '\e639'
$icon-equal-not = '\e1be'
$icon-equal = '\e1bd'
$icon-eraser = '\e28f'
$icon-ethernet-port = '\e625'
$icon-euro = '\e0bc'
$icon-expand = '\e21a'
$icon-external-link = '\e0bd'
$icon-eye-closed = '\e633'
$icon-eye-off = '\e0bf'
$icon-eye = '\e0be'
$icon-facebook = '\e0c0'
$icon-factory = '\e29f'
...
$icon-feather = '\e0c2'
$icon-fence = '\e587'
$icon-ferris-wheel = '\e484'
$icon-figma = '\e0c3'
$icon-file-archive = '\e30d'
$icon-file-audio-2 = '\e30f'
$icon-file-audio = '\e30e'
$icon-file-axis-3d = '\e310'
$icon-file-badge-2 = '\e312'
$icon-file-badge = '\e311'
$icon-file-box = '\e313'
$icon-file-chart-column-increasing = '\e315'
$icon-file-chart-column = '\e314'
$icon-file-chart-line = '\e316'
$icon-file-chart-pie = '\e317'
$icon-file-check-2 = '\e0c6'
$icon-file-check = '\e0c5'
$icon-file-clock = '\e318'
$icon-file-code-2 = '\e463'
$icon-file-code = '\e0c7'
$icon-file-cog = '\e319'
$icon-file-diff = '\e31a'
$icon-file-digit = '\e0c8'
$icon-file-down = '\e31b'
$icon-file-heart = '\e31c'
$icon-file-image = '\e31d'
$icon-file-input = '\e0c9'
$icon-file-json-2 = '\e370'
$icon-file-json = '\e36f'
$icon-file-key-2 = '\e31f'
$icon-file-key = '\e31e'
$icon-file-lock-2 = '\e321'
$icon-file-lock = '\e320'
$icon-file-minus-2 = '\e0cb'
$icon-file-minus = '\e0ca'
$icon-file-music = '\e563'
$icon-file-output = '\e0cc'
$icon-file-pen-line = '\e323'
$icon-file-pen = '\e322'
$icon-file-plus-2 = '\e0ce'
$icon-file-plus = '\e0cd'
$icon-file-question-mark = '\e324'
$icon-file-scan = '\e325'
$icon-file-search-2 = '\e326'
$icon-file-search = '\e0cf'
$icon-file-sliders = '\e5a5'
$icon-file-spreadsheet = '\e327'
$icon-file-stack = '\e4a6'
$icon-file-symlink = '\e328'
$icon-file-terminal = '\e329'
$icon-file-text = '\e0d0'
$icon-file-type-2 = '\e371'
$icon-file-type = '\e32a'
$icon-file-up = '\e32b'
$icon-file-user = '\e632'
$icon-file-video-2 = '\e32d'
$icon-file-video = '\e32c'
$icon-file-volume-2 = '\e32f'
$icon-file-volume = '\e32e'
$icon-file-warning = '\e330'
$icon-file-x-2 = '\e0d2'
$icon-file-x = '\e0d1'
$icon-file = '\e0c4'
$icon-files = '\e0d3'
$icon-film = '\e0d4'
$icon-fingerprint = '\e2cb'
$icon-fire-extinguisher = '\e583'
$icon-fish-off = '\e3b4'
$icon-fish-symbol = '\e4f9'
$icon-fish = '\e3aa'
$icon-flag-off = '\e292'
$icon-flag-triangle-left = '\e237'
$icon-flag-triangle-right = '\e238'
$icon-flag = '\e0d5'
$icon-flame-kindling = '\e53f'
$icon-flame = '\e0d6'
$icon-flashlight-off = '\e0d8'
$icon-flashlight = '\e0d7'
$icon-flask-conical-off = '\e39a'
$icon-flask-conical = '\e0d9'
$icon-flask-round = '\e0da'
$icon-flip-horizontal-2 = '\e362'
$icon-flip-horizontal = '\e361'
$icon-flip-vertical-2 = '\e364'
$icon-flip-vertical = '\e363'
$icon-flower-2 = '\e2d4'
$icon-flower = '\e2d3'
$icon-focus = '\e29e'
$icon-fold-horizontal = '\e440'
$icon-fold-vertical = '\e441'
$icon-folder-archive = '\e331'
$icon-folder-check = '\e332'
$icon-folder-clock = '\e333'
$icon-folder-closed = '\e334'
$icon-folder-code = '\e600'
$icon-folder-cog = '\e335'
$icon-folder-dot = '\e4ca'
$icon-folder-down = '\e336'
$icon-folder-git-2 = '\e40f'
$icon-folder-git = '\e40e'
$icon-folder-heart = '\e337'
$icon-folder-input = '\e338'
$icon-folder-kanban = '\e4cb'
$icon-folder-key = '\e339'
$icon-folder-lock = '\e33a'
$icon-folder-minus = '\e0dc'
$icon-folder-open-dot = '\e4cc'
$icon-folder-open = '\e247'
$icon-folder-output = '\e33b'
$icon-folder-pen = '\e33c'
$icon-folder-plus = '\e0dd'
$icon-folder-root = '\e4cd'
$icon-folder-search-2 = '\e33e'
$icon-folder-search = '\e33d'
$icon-folder-symlink = '\e33f'
$icon-folder-sync = '\e4ce'
$icon-folder-tree = '\e340'
$icon-folder-up = '\e341'
$icon-folder-x = '\e342'
$icon-folder = '\e0db'
$icon-folders = '\e343'
$icon-footprints = '\e3bd'
$icon-forklift = '\e3c5'
$icon-forward = '\e229'
$icon-frame = '\e291'
$icon-framer = '\e0de'
$icon-frown = '\e0df'
$icon-fuel = '\e2af'
$icon-fullscreen = '\e539'
$icon-funnel-plus = '\e0e1'
$icon-funnel-x = '\e3b9'
$icon-funnel = '\e0e0'
$icon-gallery-horizontal-end = '\e4d4'
$icon-gallery-horizontal = '\e4d3'
$icon-gallery-thumbnails = '\e4d5'
$icon-gallery-vertical-end = '\e4d7'
$icon-gallery-vertical = '\e4d6'
$icon-gamepad-2 = '\e0e3'
$icon-gamepad = '\e0e2'
$icon-gauge = '\e1bf'
$icon-gavel = '\e0e4'
$icon-gem = '\e242'
$icon-georgian-lari = '\e67d'
$icon-ghost = '\e20e'
$icon-gift = '\e0e5'
$icon-git-branch-plus = '\e1f4'
$icon-git-branch = '\e0e6'
$icon-git-commit-horizontal = '\e0e7'
$icon-git-commit-vertical = '\e557'
$icon-git-compare-arrows = '\e558'
$icon-git-compare = '\e35d'
$icon-git-fork = '\e28d'
$icon-git-graph = '\e559'
$icon-git-merge = '\e0e8'
$icon-git-pull-request-arrow = '\e55a'
$icon-git-pull-request-closed = '\e35e'
$icon-git-pull-request-create-arrow = '\e55c'
$icon-git-pull-request-create = '\e55b'
$icon-git-pull-request-draft = '\e35f'
$icon-git-pull-request = '\e0e9'
$icon-github = '\e0ea'
$icon-gitlab = '\e0eb'
$icon-glass-water = '\e2d5'
$icon-glasses = '\e20d'
$icon-globe-lock = '\e5d2'
$icon-globe = '\e0ec'
$icon-goal = '\e4aa'
$icon-gpu = '\e66f'
$icon-grab = '\e1e6'
$icon-graduation-cap = '\e234'
$icon-grape = '\e356'
$icon-grid-2x2-check = '\e5e9'
$icon-grid-2x2-plus = '\e62d'
$icon-grid-2x2-x = '\e5ea'
$icon-grid-2x2 = '\e504'
$icon-grid-3x2 = '\e674'
$icon-grid-3x3 = '\e0ed'
$icon-grip-horizontal = '\e0ee'
$icon-grip-vertical = '\e0ef'
$icon-grip = '\e3b5'
$icon-group = '\e469'
$icon-guitar = '\e564'
$icon-ham = '\e5dc'
$icon-hamburger = '\e66a'
$icon-hammer = '\e0f0'
$icon-hand-coins = '\e5bd'
$icon-hand-heart = '\e5be'
$icon-hand-helping = '\e3bc'
$icon-hand-metal = '\e22c'
$icon-hand-platter = '\e5bf'
$icon-hand = '\e1d7'
$icon-handshake = '\e5c5'
$icon-hard-drive-download = '\e4ea'
$icon-hard-drive-upload = '\e4eb'
$icon-hard-drive = '\e0f1'
$icon-hard-hat = '\e0f2'
$icon-hash = '\e0f3'
$icon-haze = '\e0f4'
$icon-hdmi-port = '\e4ec'
...
$icon-heading-6 = '\e38e'
$icon-heading = '\e388'
$icon-headphone-off = '\e62e'
$icon-headphones = '\e0f5'
$icon-headset = '\e5c2'
$icon-heart-crack = '\e2d6'
$icon-heart-handshake = '\e2d7'
$icon-heart-minus = '\e656'
$icon-heart-off = '\e295'
$icon-heart-plus = '\e657'
$icon-heart-pulse = '\e372'
$icon-heart = '\e0f6'
$icon-heater = '\e593'
$icon-hexagon = '\e0f7'
$icon-highlighter = '\e0f8'
$icon-history = '\e1f5'
$icon-hop-off = '\e39c'
$icon-hop = '\e39b'
$icon-hospital = '\e5dd'
$icon-hotel = '\e3e6'
$icon-hourglass = '\e296'
$icon-house-plug = '\e5f5'
$icon-house-plus = '\e5f6'
$icon-house-wifi = '\e641'
$icon-house = '\e0f9'
$icon-ice-cream-bowl = '\e3ab'
$icon-ice-cream-cone = '\e357'
$icon-id-card-lanyard = '\e675'
$icon-id-card = '\e61c'
$icon-image-down = '\e541'
$icon-image-minus = '\e1f6'
$icon-image-off = '\e1c0'
$icon-image-play = '\e5e4'
$icon-image-plus = '\e1f7'
$icon-image-up = '\e5d0'
$icon-image-upscale = '\e63c'
$icon-image = '\e0fa'
$icon-images = '\e5c9'
$icon-import = '\e22f'
$icon-inbox = '\e0fb'
$icon-indent-decrease = '\e0fc'
$icon-indent-increase = '\e0fd'
$icon-indian-rupee = '\e0fe'
$icon-infinity = '\e1e7'
$icon-info = '\e0ff'
$icon-inspection-panel = '\e588'
$icon-instagram = '\e100'
$icon-italic = '\e101'
$icon-iteration-ccw = '\e428'
$icon-iteration-cw = '\e429'
$icon-japanese-yen = '\e102'
$icon-joystick = '\e359'
$icon-kanban = '\e4e1'
$icon-key-round = '\e4a8'
$icon-key-square = '\e4a9'
$icon-key = '\e103'
$icon-keyboard-music = '\e565'
$icon-keyboard-off = '\e5e3'
$icon-keyboard = '\e284'
$icon-lamp-ceiling = '\e2d9'
$icon-lamp-desk = '\e2da'
$icon-lamp-floor = '\e2db'
$icon-lamp-wall-down = '\e2dc'
$icon-lamp-wall-up = '\e2dd'
$icon-lamp = '\e2d8'
$icon-land-plot = '\e52d'
$icon-landmark = '\e23a'
$icon-languages = '\e104'
$icon-laptop-minimal-check = '\e637'
$icon-laptop-minimal = '\e1d8'
$icon-laptop = '\e1cd'
$icon-lasso-select = '\e1cf'
$icon-lasso = '\e1ce'
$icon-laugh = '\e300'
$icon-layers-2 = '\e52f'
$icon-layers = '\e52e'
$icon-layout-dashboard = '\e1c1'
$icon-layout-grid = '\e105'
$icon-layout-list = '\e1d9'
$icon-layout-panel-left = '\e475'
$icon-layout-panel-top = '\e476'
$icon-layout-template = '\e207'
$icon-leaf = '\e2de'
$icon-leafy-green = '\e474'
$icon-lectern = '\e5ee'
$icon-letter-text = '\e60a'
$icon-library-big = '\e553'
$icon-library = '\e106'
$icon-life-buoy = '\e107'
$icon-ligature = '\e43f'
$icon-lightbulb-off = '\e208'
$icon-lightbulb = '\e1c2'
$icon-line-squiggle = '\e67f'
$icon-link-2-off = '\e10a'
$icon-link-2 = '\e109'
$icon-link = '\e108'
$icon-linkedin = '\e10b'
$icon-list-check = '\e5ff'
$icon-list-checks = '\e1d0'
$icon-list-collapse = '\e5a0'
$icon-list-end = '\e2df'
$icon-list-filter-plus = '\e63e'
$icon-list-filter = '\e465'
$icon-list-minus = '\e23e'
$icon-list-music = '\e2e0'
$icon-list-ordered = '\e1d1'
$icon-list-plus = '\e23f'
$icon-list-restart = '\e457'
$icon-list-start = '\e2e1'
$icon-list-todo = '\e4c8'
$icon-list-tree = '\e40d'
$icon-list-video = '\e2e2'
$icon-list-x = '\e240'
$icon-list = '\e10c'
$icon-loader-circle = '\e10e'
$icon-loader-pinwheel = '\e5eb'
$icon-loader = '\e10d'
$icon-locate-fixed = '\e1db'
$icon-locate-off = '\e282'
$icon-locate = '\e1da'
$icon-location-edit = '\e65a'
$icon-lock-keyhole-open = '\e537'
$icon-lock-keyhole = '\e536'
$icon-lock-open = '\e110'
$icon-lock = '\e10f'
$icon-log-in = '\e111'
$icon-log-out = '\e112'
...
$icon-luggage = '\e2ca'
$icon-magnet = '\e2b5'
$icon-mail-check = '\e365'
$icon-mail-minus = '\e366'
$icon-mail-open = '\e367'
$icon-mail-plus = '\e368'
$icon-mail-question-mark = '\e369'
$icon-mail-search = '\e36a'
$icon-mail-warning = '\e36b'
$icon-mail-x = '\e36c'
$icon-mail = '\e113'
$icon-mailbox = '\e3d8'
$icon-mails = '\e36d'
$icon-map-pin-check-inside = '\e615'
$icon-map-pin-check = '\e614'
$icon-map-pin-house = '\e621'
$icon-map-pin-minus-inside = '\e617'
$icon-map-pin-minus = '\e616'
$icon-map-pin-off = '\e2a6'
$icon-map-pin-plus-inside = '\e619'
$icon-map-pin-plus = '\e618'
$icon-map-pin-x-inside = '\e61b'
$icon-map-pin-x = '\e61a'
$icon-map-pin = '\e115'
$icon-map-pinned = '\e542'
$icon-map-plus = '\e644'
$icon-map = '\e114'
$icon-mars-stroke = '\e647'
$icon-mars = '\e646'
$icon-martini = '\e2e3'
$icon-maximize-2 = '\e117'
$icon-maximize = '\e116'
$icon-medal = '\e373'
$icon-megaphone-off = '\e374'
$icon-megaphone = '\e235'
$icon-meh = '\e118'
$icon-memory-stick = '\e44a'
$icon-menu = '\e119'
$icon-merge = '\e444'
$icon-message-circle-code = '\e567'
$icon-message-circle-dashed = '\e568'
$icon-message-circle-heart = '\e569'
$icon-message-circle-more = '\e56a'
$icon-message-circle-off = '\e56b'
$icon-message-circle-plus = '\e56c'
$icon-message-circle-question-mark = '\e56d'
$icon-message-circle-reply = '\e56e'
$icon-message-circle-warning = '\e56f'
$icon-message-circle-x = '\e570'
$icon-message-circle = '\e11a'
$icon-message-square-code = '\e571'
$icon-message-square-dashed = '\e410'
$icon-message-square-diff = '\e572'
$icon-message-square-dot = '\e573'
$icon-message-square-heart = '\e574'
$icon-message-square-lock = '\e631'
$icon-message-square-more = '\e575'
$icon-message-square-off = '\e576'
$icon-message-square-plus = '\e411'
$icon-message-square-quote = '\e577'
$icon-message-square-reply = '\e578'
$icon-message-square-share = '\e579'
$icon-message-square-text = '\e57a'
$icon-message-square-warning = '\e57b'
$icon-message-square-x = '\e57c'
$icon-message-square = '\e11b'
$icon-messages-square = '\e412'
$icon-mic-off = '\e11d'
$icon-mic-vocal = '\e34d'
$icon-mic = '\e11c'
$icon-microchip = '\e61f'
$icon-microscope = '\e2e4'
$icon-microwave = '\e37e'
$icon-milestone = '\e298'
$icon-milk-off = '\e39e'
$icon-milk = '\e39d'
$icon-minimize-2 = '\e11f'
$icon-minimize = '\e11e'
$icon-minus = '\e120'
$icon-monitor-check = '\e487'
$icon-monitor-cog = '\e608'
$icon-monitor-dot = '\e488'
$icon-monitor-down = '\e426'
$icon-monitor-off = '\e1dc'
$icon-monitor-pause = '\e489'
$icon-monitor-play = '\e48a'
$icon-monitor-smartphone = '\e3a6'
$icon-monitor-speaker = '\e210'
$icon-monitor-stop = '\e48b'
$icon-monitor-up = '\e427'
$icon-monitor-x = '\e48c'
$icon-monitor = '\e121'
$icon-moon-star = '\e415'
$icon-moon = '\e122'
$icon-mountain-snow = '\e232'
$icon-mountain = '\e231'
$icon-mouse-off = '\e5e0'
$icon-mouse-pointer-2 = '\e1c3'
$icon-mouse-pointer-ban = '\e5ec'
$icon-mouse-pointer-click = '\e124'
$icon-mouse-pointer = '\e123'
$icon-mouse = '\e28e'
$icon-move-3d = '\e2e5'
$icon-move-diagonal-2 = '\e1c5'
$icon-move-diagonal = '\e1c4'
$icon-move-down-left = '\e492'
$icon-move-down-right = '\e493'
$icon-move-down = '\e491'
$icon-move-horizontal = '\e1c6'
$icon-move-left = '\e494'
$icon-move-right = '\e495'
$icon-move-up-left = '\e497'
$icon-move-up-right = '\e498'
$icon-move-up = '\e496'
$icon-move-vertical = '\e1c7'
$icon-move = '\e125'
$icon-music-2 = '\e34e'
$icon-music-3 = '\e34f'
$icon-music-4 = '\e350'
$icon-music = '\e126'
$icon-navigation-2-off = '\e2a7'
$icon-navigation-2 = '\e128'
$icon-navigation-off = '\e2a8'
$icon-navigation = '\e127'
$icon-network = '\e129'
$icon-newspaper = '\e34c'
$icon-nfc = '\e3c7'
$icon-non-binary = '\e648'
$icon-notebook-pen = '\e59b'
$icon-notebook-tabs = '\e59c'
$icon-notebook-text = '\e59d'
$icon-notebook = '\e59a'
$icon-notepad-text-dashed = '\e59f'
$icon-notepad-text = '\e59e'
$icon-nut-off = '\e3a0'
$icon-nut = '\e39f'
$icon-octagon-alert = '\e12b'
$icon-octagon-minus = '\e62c'
$icon-octagon-pause = '\e21b'
$icon-octagon-x = '\e12c'
$icon-octagon = '\e12a'
$icon-omega = '\e61e'
$icon-option = '\e1f8'
...
$icon-origami = '\e5e8'
$icon-package-2 = '\e344'
$icon-package-check = '\e266'
$icon-package-minus = '\e267'
$icon-package-open = '\e2cc'
$icon-package-plus = '\e268'
$icon-package-search = '\e269'
$icon-package-x = '\e26a'
$icon-package = '\e12d'
$icon-paint-bucket = '\e2e6'
$icon-paint-roller = '\e5a3'
$icon-paintbrush-vertical = '\e2e8'
$icon-paintbrush = '\e2e7'
$icon-palette = '\e1dd'
$icon-panda = '\e66d'
$icon-panel-bottom-close = '\e432'
$icon-panel-bottom-dashed = '\e433'
$icon-panel-bottom-open = '\e434'
$icon-panel-bottom = '\e431'
$icon-panel-left-close = '\e21c'
$icon-panel-left-dashed = '\e435'
$icon-panel-left-open = '\e21d'
$icon-panel-left = '\e12e'
$icon-panel-right-close = '\e437'
$icon-panel-right-dashed = '\e438'
$icon-panel-right-open = '\e439'
$icon-panel-right = '\e436'
$icon-panel-top-close = '\e43b'
$icon-panel-top-dashed = '\e43c'
$icon-panel-top-open = '\e43d'
$icon-panel-top = '\e43a'
$icon-panels-left-bottom = '\e12f'
$icon-panels-right-bottom = '\e58d'
$icon-panels-top-left = '\e130'
$icon-paperclip = '\e131'
$icon-parentheses = '\e449'
$icon-parking-meter = '\e505'
$icon-party-popper = '\e347'
$icon-pause = '\e132'
$icon-paw-print = '\e4fa'
$icon-pc-case = '\e44b'
$icon-pen-line = '\e134'
...
$icon-pen-tool = '\e135'
$icon-pen = '\e133'
$icon-pencil-line = '\e4f5'
$icon-pencil-off = '\e5f4'
$icon-pencil-ruler = '\e4f6'
$icon-pencil = '\e1f9'
$icon-pentagon = '\e530'
$icon-percent = '\e136'
$icon-person-standing = '\e21e'
$icon-philippine-peso = '\e609'
$icon-phone-call = '\e138'
$icon-phone-forwarded = '\e139'
$icon-phone-incoming = '\e13a'
$icon-phone-missed = '\e13b'
$icon-phone-off = '\e13c'
$icon-phone-outgoing = '\e13d'
$icon-phone = '\e137'
$icon-pi = '\e477'
$icon-piano = '\e566'
$icon-pickaxe = '\e5cb'
$icon-picture-in-picture-2 = '\e3b3'
$icon-picture-in-picture = '\e3b2'
$icon-piggy-bank = '\e13e'
$icon-pilcrow-left = '\e5e1'
$icon-pilcrow-right = '\e5e2'
$icon-pilcrow = '\e3a7'
$icon-pill-bottle = '\e5ef'
$icon-pill = '\e3c1'
$icon-pin-off = '\e2b6'
$icon-pin = '\e259'
$icon-pipette = '\e13f'
$icon-pizza = '\e358'
$icon-plane-landing = '\e3d1'
$icon-plane-takeoff = '\e3d2'
$icon-plane = '\e1de'
$icon-play = '\e140'
$icon-plug-2 = '\e384'
$icon-plug-zap = '\e461'
$icon-plug = '\e383'
$icon-plus = '\e141'
$icon-pocket-knife = '\e4a5'
$icon-pocket = '\e142'
$icon-podcast = '\e1fa'
$icon-pointer-off = '\e584'
$icon-pointer = '\e1e8'
$icon-popcorn = '\e4c3'
$icon-popsicle = '\e4c4'
$icon-pound-sterling = '\e143'
$icon-power-off = '\e209'
$icon-power = '\e144'
$icon-presentation = '\e4b3'
$icon-printer-check = '\e5fa'
$icon-printer = '\e145'
$icon-projector = '\e4b4'
$icon-proportions = '\e5d4'
$icon-puzzle = '\e29c'
$icon-pyramid = '\e531'
$icon-qr-code = '\e1df'
$icon-quote = '\e239'
...
$icon-radiation = '\e447'
$icon-radical = '\e5c7'
$icon-radio-receiver = '\e1fb'
$icon-radio-tower = '\e409'
$icon-radio = '\e146'
$icon-radius = '\e532'
$icon-rail-symbol = '\e506'
$icon-rainbow = '\e4c7'
$icon-rat = '\e3f0'
$icon-ratio = '\e4ed'
$icon-receipt-cent = '\e5aa'
$icon-receipt-euro = '\e5ab'
$icon-receipt-indian-rupee = '\e5ac'
$icon-receipt-japanese-yen = '\e5ad'
$icon-receipt-pound-sterling = '\e5ae'
$icon-receipt-russian-ruble = '\e5af'
$icon-receipt-swiss-franc = '\e5b0'
$icon-receipt-text = '\e5b1'
$icon-receipt = '\e3d7'
$icon-rectangle-circle = '\e678'
$icon-rectangle-ellipsis = '\e21f'
$icon-rectangle-goggles = '\e65b'
$icon-rectangle-horizontal = '\e37a'
$icon-rectangle-vertical = '\e37b'
$icon-recycle = '\e2e9'
$icon-redo-2 = '\e2a0'
$icon-redo-dot = '\e455'
$icon-redo = '\e147'
$icon-refresh-ccw-dot = '\e4b7'
$icon-refresh-ccw = '\e148'
$icon-refresh-cw-off = '\e49d'
$icon-refresh-cw = '\e149'
$icon-refrigerator = '\e37f'
$icon-regex = '\e1fc'
$icon-remove-formatting = '\e3b7'
$icon-repeat-1 = '\e1fd'
$icon-repeat-2 = '\e416'
$icon-repeat = '\e14a'
$icon-replace-all = '\e3e0'
$icon-replace = '\e3df'
$icon-reply-all = '\e22b'
$icon-reply = '\e22a'
$icon-rewind = '\e14b'
$icon-ribbon = '\e55d'
$icon-rocket = '\e286'
$icon-rocking-chair = '\e233'
$icon-roller-coaster = '\e485'
$icon-rotate-3d = '\e2ea'
$icon-rotate-ccw-key = '\e655'
$icon-rotate-ccw-square = '\e5d5'
$icon-rotate-ccw = '\e14c'
$icon-rotate-cw-square = '\e5d6'
$icon-rotate-cw = '\e14d'
$icon-route-off = '\e544'
$icon-route = '\e543'
$icon-router = '\e3c3'
...
$icon-rows-4 = '\e590'
$icon-rss = '\e14e'
$icon-ruler-dimension-line = '\e667'
$icon-ruler = '\e14f'
$icon-russian-ruble = '\e150'
$icon-sailboat = '\e382'
$icon-salad = '\e3ac'
$icon-sandwich = '\e3ad'
$icon-satellite-dish = '\e44d'
$icon-satellite = '\e44c'
$icon-saudi-riyal = '\e650'
$icon-save-all = '\e414'
$icon-save-off = '\e5f8'
$icon-save = '\e151'
$icon-scale-3d = '\e2eb'
$icon-scale = '\e212'
$icon-scaling = '\e2ec'
$icon-scan-barcode = '\e53a'
$icon-scan-eye = '\e53b'
$icon-scan-face = '\e375'
$icon-scan-heart = '\e63f'
$icon-scan-line = '\e258'
$icon-scan-qr-code = '\e5fb'
$icon-scan-search = '\e53c'
$icon-scan-text = '\e53d'
$icon-scan = '\e257'
$icon-school = '\e3e7'
$icon-scissors-line-dashed = '\e4ee'
$icon-scissors = '\e152'
$icon-screen-share-off = '\e154'
$icon-screen-share = '\e153'
$icon-scroll-text = '\e464'
$icon-scroll = '\e2ed'
$icon-search-check = '\e4af'
$icon-search-code = '\e4b0'
$icon-search-slash = '\e4b1'
$icon-search-x = '\e4b2'
$icon-search = '\e155'
$icon-section = '\e5ed'
$icon-send-horizontal = '\e4f7'
$icon-send-to-back = '\e4f8'
$icon-send = '\e156'
$icon-separator-horizontal = '\e1c8'
$icon-separator-vertical = '\e1c9'
$icon-server-cog = '\e345'
$icon-server-crash = '\e1e9'
$icon-server-off = '\e1ea'
$icon-server = '\e157'
$icon-settings-2 = '\e245'
$icon-settings = '\e158'
$icon-shapes = '\e4b8'
$icon-share-2 = '\e15a'
$icon-share = '\e159'
$icon-sheet = '\e15b'
$icon-shell = '\e4fc'
$icon-shield-alert = '\e1fe'
$icon-shield-ban = '\e15d'
$icon-shield-check = '\e1ff'
$icon-shield-ellipsis = '\e51b'
$icon-shield-half = '\e51c'
$icon-shield-minus = '\e51d'
$icon-shield-off = '\e15e'
$icon-shield-plus = '\e51e'
$icon-shield-question-mark = '\e413'
$icon-shield-user = '\e64c'
$icon-shield-x = '\e200'
$icon-shield = '\e15c'
$icon-ship-wheel = '\e507'
$icon-ship = '\e3be'
$icon-shirt = '\e1ca'
$icon-shopping-bag = '\e15f'
$icon-shopping-basket = '\e4ef'
$icon-shopping-cart = '\e160'
$icon-shovel = '\e161'
$icon-shower-head = '\e380'
$icon-shredder = '\e660'
$icon-shrimp = '\e64e'
$icon-shrink = '\e220'
$icon-shrub = '\e2ee'
$icon-shuffle = '\e162'
$icon-sigma = '\e201'
$icon-signal-high = '\e260'
$icon-signal-low = '\e261'
$icon-signal-medium = '\e262'
$icon-signal-zero = '\e263'
$icon-signal = '\e25f'
$icon-signature = '\e5f7'
$icon-signpost-big = '\e546'
$icon-signpost = '\e545'
$icon-siren = '\e2ef'
$icon-skip-back = '\e163'
$icon-skip-forward = '\e164'
$icon-skull = '\e221'
$icon-slack = '\e165'
$icon-slash = '\e522'
$icon-slice = '\e2f0'
$icon-sliders-horizontal = '\e29a'
$icon-sliders-vertical = '\e166'
$icon-smartphone-charging = '\e22e'
$icon-smartphone-nfc = '\e3c8'
$icon-smartphone = '\e167'
$icon-smile-plus = '\e301'
$icon-smile = '\e168'
$icon-snail = '\e4fd'
$icon-snowflake = '\e169'
$icon-soap-dispenser-droplet = '\e66e'
$icon-sofa = '\e2c4'
$icon-soup = '\e3ae'
$icon-space = '\e3e1'
$icon-spade = '\e49e'
...
$icon-speaker = '\e16a'
$icon-speech = '\e523'
$icon-spell-check-2 = '\e4a0'
$icon-spell-check = '\e49f'
$icon-spline-pointer = '\e654'
$icon-spline = '\e38f'
$icon-split = '\e445'
$icon-spool = '\e67c'
$icon-spray-can = '\e49a'
$icon-sprout = '\e1eb'
$icon-square-activity = '\e4b9'
$icon-square-arrow-down-left = '\e4ba'
$icon-square-arrow-down-right = '\e4bb'
$icon-square-arrow-down = '\e42c'
$icon-square-arrow-left = '\e42d'
$icon-square-arrow-out-down-left = '\e5a6'
$icon-square-arrow-out-down-right = '\e5a7'
$icon-square-arrow-out-up-left = '\e5a8'
$icon-square-arrow-out-up-right = '\e5a9'
$icon-square-arrow-right = '\e42e'
$icon-square-arrow-up-left = '\e4bc'
$icon-square-arrow-up-right = '\e4bd'
$icon-square-arrow-up = '\e42f'
$icon-square-asterisk = '\e16c'
$icon-square-bottom-dashed-scissors = '\e4f0'
$icon-square-chart-gantt = '\e16d'
$icon-square-check-big = '\e16e'
$icon-square-check = '\e55e'
$icon-square-chevron-down = '\e3d3'
$icon-square-chevron-left = '\e3d4'
$icon-square-chevron-right = '\e3d5'
$icon-square-chevron-up = '\e3d6'
$icon-square-code = '\e16f'
$icon-square-dashed-bottom-code = '\e4c6'
$icon-square-dashed-bottom = '\e4c5'
$icon-square-dashed-kanban = '\e170'
$icon-square-dashed-mouse-pointer = '\e50e'
$icon-square-dashed-top-solid = '\e671'
$icon-square-dashed = '\e1cb'
$icon-square-divide = '\e171'
$icon-square-dot = '\e172'
$icon-square-equal = '\e173'
$icon-square-function = '\e22d'
$icon-square-kanban = '\e174'
$icon-square-library = '\e554'
$icon-square-m = '\e508'
$icon-square-menu = '\e458'
$icon-square-minus = '\e175'
$icon-square-mouse-pointer = '\e202'
$icon-square-parking-off = '\e3d0'
$icon-square-parking = '\e3cf'
$icon-square-pen = '\e176'
$icon-square-percent = '\e521'
$icon-square-pi = '\e48d'
$icon-square-pilcrow = '\e490'
$icon-square-play = '\e486'
$icon-square-plus = '\e177'
$icon-square-power = '\e556'
$icon-square-radical = '\e5c8'
$icon-square-round-corner = '\e64d'
$icon-square-scissors = '\e4f1'
$icon-square-sigma = '\e48e'
$icon-square-slash = '\e178'
$icon-square-split-horizontal = '\e3ba'
$icon-square-split-vertical = '\e3bb'
$icon-square-square = '\e613'
$icon-square-stack = '\e4a7'
$icon-square-terminal = '\e20a'
$icon-square-user-round = '\e46b'
$icon-square-user = '\e46a'
$icon-square-x = '\e179'
$icon-square = '\e16b'
$icon-squares-exclude = '\e65c'
$icon-squares-intersect = '\e65d'
$icon-squares-subtract = '\e65e'
$icon-squares-unite = '\e65f'
$icon-squircle-dashed = '\e67e'
$icon-squircle = '\e57f'
$icon-squirrel = '\e4a4'
$icon-stamp = '\e3bf'
$icon-star-half = '\e20b'
...
$icon-star = '\e17a'
$icon-step-back = '\e3ed'
$icon-step-forward = '\e3ee'
$icon-stethoscope = '\e2f1'
$icon-sticker = '\e302'
$icon-sticky-note = '\e303'
$icon-store = '\e3e8'
$icon-stretch-horizontal = '\e27c'
$icon-stretch-vertical = '\e27d'
$icon-strikethrough = '\e17b'
$icon-subscript = '\e25c'
$icon-sun-dim = '\e299'
$icon-sun-medium = '\e2b1'
$icon-sun-moon = '\e2b2'
$icon-sun-snow = '\e376'
$icon-sun = '\e17c'
$icon-sunrise = '\e17d'
$icon-sunset = '\e17e'
$icon-superscript = '\e25e'
$icon-swatch-book = '\e5a4'
$icon-swiss-franc = '\e17f'
$icon-switch-camera = '\e180'
$icon-sword = '\e2b3'
$icon-swords = '\e2b4'
$icon-syringe = '\e2f2'
$icon-table-2 = '\e2f9'
$icon-table-cells-merge = '\e5cc'
$icon-table-cells-split = '\e5cd'
$icon-table-columns-split = '\e5ce'
$icon-table-of-contents = '\e623'
$icon-table-properties = '\e4e0'
$icon-table-rows-split = '\e5cf'
$icon-table = '\e181'
$icon-tablet-smartphone = '\e50f'
$icon-tablet = '\e182'
$icon-tablets = '\e3c2'
$icon-tag = '\e183'
$icon-tags = '\e360'
...
$icon-tent = '\e227'
$icon-terminal = '\e185'
$icon-test-tube-diagonal = '\e40b'
$icon-test-tube = '\e40a'
$icon-test-tubes = '\e40c'
$icon-text-cursor-input = '\e265'
$icon-text-cursor = '\e264'
$icon-text-quote = '\e4a3'
$icon-text-search = '\e5b2'
$icon-text-select = '\e3e2'
$icon-text = '\e3ef'
$icon-theater = '\e527'
$icon-thermometer-snowflake = '\e187'
$icon-thermometer-sun = '\e188'
$icon-thermometer = '\e186'
$icon-thumbs-down = '\e189'
$icon-thumbs-up = '\e18a'
$icon-ticket-check = '\e5b3'
$icon-ticket-minus = '\e5b4'
$icon-ticket-percent = '\e5b5'
$icon-ticket-plus = '\e5b6'
$icon-ticket-slash = '\e5b7'
$icon-ticket-x = '\e5b8'
$icon-ticket = '\e20f'
$icon-tickets-plane = '\e628'
$icon-tickets = '\e627'
$icon-timer-off = '\e249'
$icon-timer-reset = '\e236'
$icon-timer = '\e1e0'
$icon-toggle-left = '\e18b'
$icon-toggle-right = '\e18c'
$icon-toilet = '\e63a'
$icon-tornado = '\e218'
$icon-torus = '\e534'
$icon-touchpad-off = '\e44f'
$icon-touchpad = '\e44e'
$icon-tower-control = '\e3c0'
$icon-toy-brick = '\e34b'
$icon-tractor = '\e509'
$icon-traffic-cone = '\e50a'
$icon-train-front-tunnel = '\e50c'
$icon-train-front = '\e50b'
$icon-train-track = '\e50d'
$icon-tram-front = '\e2a9'
$icon-transgender = '\e649'
$icon-trash-2 = '\e18e'
$icon-trash = '\e18d'
$icon-tree-deciduous = '\e2f3'
$icon-tree-palm = '\e281'
$icon-tree-pine = '\e2f4'
$icon-trees = '\e2f5'
$icon-trello = '\e18f'
$icon-trending-down = '\e190'
$icon-trending-up-down = '\e62a'
$icon-trending-up = '\e191'
$icon-triangle-alert = '\e193'
$icon-triangle-dashed = '\e642'
$icon-triangle-right = '\e4f2'
$icon-triangle = '\e192'
$icon-trophy = '\e377'
$icon-truck-electric = '\e664'
$icon-truck = '\e194'
$icon-turtle = '\e4fe'
$icon-tv-minimal-play = '\e5f1'
$icon-tv-minimal = '\e203'
$icon-tv = '\e195'
$icon-twitch = '\e196'
$icon-twitter = '\e197'
$icon-type-outline = '\e607'
$icon-type = '\e198'
$icon-umbrella-off = '\e548'
$icon-umbrella = '\e199'
$icon-underline = '\e19a'
$icon-undo-2 = '\e2a1'
$icon-undo-dot = '\e456'
$icon-undo = '\e19b'
$icon-unfold-horizontal = '\e442'
$icon-unfold-vertical = '\e443'
$icon-ungroup = '\e46c'
$icon-university = '\e3e9'
$icon-unlink-2 = '\e19d'
$icon-unlink = '\e19c'
$icon-unplug = '\e462'
$icon-upload = '\e19e'
$icon-usb = '\e35a'
$icon-user-check = '\e1a0'
$icon-user-cog = '\e346'
$icon-user-lock = '\e665'
$icon-user-minus = '\e1a1'
$icon-user-pen = '\e601'
$icon-user-plus = '\e1a2'
$icon-user-round-check = '\e46e'
$icon-user-round-cog = '\e46f'
$icon-user-round-minus = '\e470'
$icon-user-round-pen = '\e602'
$icon-user-round-plus = '\e471'
$icon-user-round-search = '\e57d'
$icon-user-round-x = '\e472'
$icon-user-round = '\e46d'
$icon-user-search = '\e57e'
$icon-user-x = '\e1a3'
$icon-user = '\e19f'
$icon-users-round = '\e473'
$icon-users = '\e1a4'
$icon-utensils-crossed = '\e2f7'
$icon-utensils = '\e2f6'
$icon-utility-pole = '\e3c6'
$icon-variable = '\e478'
$icon-vault = '\e594'
$icon-vegan = '\e3a1'
$icon-venetian-mask = '\e2aa'
$icon-venus-and-mars = '\e64b'
$icon-venus = '\e64a'
$icon-vibrate-off = '\e29d'
$icon-vibrate = '\e223'
$icon-video-off = '\e1a6'
$icon-video = '\e1a5'
$icon-videotape = '\e4d0'
$icon-view = '\e1a7'
$icon-voicemail = '\e1a8'
$icon-volleyball = '\e634'
$icon-volume-1 = '\e1aa'
$icon-volume-2 = '\e1ab'
$icon-volume-off = '\e62b'
$icon-volume-x = '\e1ac'
$icon-volume = '\e1a9'
$icon-vote = '\e3b1'
$icon-wallet-cards = '\e4d1'
$icon-wallet-minimal = '\e4d2'
$icon-wallet = '\e204'
$icon-wallpaper = '\e450'
$icon-wand-sparkles = '\e35b'
$icon-wand = '\e246'
$icon-warehouse = '\e3ea'
$icon-washing-machine = '\e595'
$icon-watch = '\e1ad'
$icon-waves-ladder = '\e640'
$icon-waves = '\e283'
$icon-waypoints = '\e547'
$icon-webcam = '\e205'
$icon-webhook-off = '\e5bc'
$icon-webhook = '\e378'
$icon-weight = '\e535'
$icon-wheat-off = '\e3a3'
$icon-wheat = '\e3a2'
$icon-whole-word = '\e3e3'
$icon-wifi-cog = '\e679'
$icon-wifi-high = '\e5fc'
$icon-wifi-low = '\e5fd'
$icon-wifi-off = '\e1af'
