...
<body>
  ...
  <div class="icons">
    <ul>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-badge-question-mark"></use>
          </svg>
          <h4>icon-badge-question-mark</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-barrel"></use>
          </svg>
          <h4>icon-barrel</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-book-alert"></use>
          </svg>
          <h4>icon-book-alert</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-bow-arrow"></use>
          </svg>
          <h4>icon-bow-arrow</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-brick-wall-fire"></use>
          </svg>
          <h4>icon-brick-wall-fire</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-brush-cleaning"></use>
          </svg>
          <h4>icon-brush-cleaning</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-bubbles"></use>
          </svg>
          <h4>icon-bubbles</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-card-sim"></use>
          </svg>
          <h4>icon-card-sim</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-check-line"></use>
          </svg>
          <h4>icon-check-line</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-circle-pound-sterling"></use>
          </svg>
          <h4>icon-circle-pound-sterling</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-circle-question-mark"></use>
          </svg>
          <h4>icon-circle-question-mark</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-clock-plus"></use>
          </svg>
          <h4>icon-clock-plus</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-cloud-check"></use>
          </svg>
          <h4>icon-cloud-check</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-columns-3-cog"></use>
          </svg>
          <h4>icon-columns-3-cog</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-decimals-arrow-left"></use>
          </svg>
          <h4>icon-decimals-arrow-left</h4>
        </li>
      
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-decimals-arrow-right"></use>
          </svg>
          <h4>icon-decimals-arrow-right</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-door-closed-locked"></use>
          </svg>
          <h4>icon-door-closed-locked</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-drone"></use>
          </svg>
          <h4>icon-drone</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-file-question-mark"></use>
          </svg>
          <h4>icon-file-question-mark</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-georgian-lari"></use>
          </svg>
          <h4>icon-georgian-lari</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-gpu"></use>
          </svg>
          <h4>icon-gpu</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-grid-3x2"></use>
          </svg>
          <h4>icon-grid-3x2</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-hamburger"></use>
          </svg>
          <h4>icon-hamburger</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-heart-minus"></use>
          </svg>
          <h4>icon-heart-minus</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-heart-plus"></use>
          </svg>
          <h4>icon-heart-plus</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-id-card-lanyard"></use>
          </svg>
          <h4>icon-id-card-lanyard</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-line-squiggle"></use>
          </svg>
          <h4>icon-line-squiggle</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-location-edit"></use>
          </svg>
          <h4>icon-location-edit</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-mail-question-mark"></use>
          </svg>
          <h4>icon-mail-question-mark</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-message-circle-question-mark"></use>
          </svg>
          <h4>icon-message-circle-question-mark</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-panda"></use>
          </svg>
          <h4>icon-panda</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-rectangle-circle"></use>
          </svg>
          <h4>icon-rectangle-circle</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-rectangle-goggles"></use>
          </svg>
          <h4>icon-rectangle-goggles</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-rotate-ccw-key"></use>
          </svg>
          <h4>icon-rotate-ccw-key</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-ruler-dimension-line"></use>
          </svg>
          <h4>icon-ruler-dimension-line</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-shield-question-mark"></use>
          </svg>
          <h4>icon-shield-question-mark</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-shredder"></use>
          </svg>
          <h4>icon-shredder</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-soap-dispenser-droplet"></use>
          </svg>
          <h4>icon-soap-dispenser-droplet</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-spool"></use>
          </svg>
          <h4>icon-spool</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-square-dashed-top-solid"></use>
          </svg>
          <h4>icon-square-dashed-top-solid</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-squares-exclude"></use>
          </svg>
          <h4>icon-squares-exclude</h4>
        </li>
      
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-squares-intersect"></use>
          </svg>
          <h4>icon-squares-intersect</h4>
        </li>
      
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-squares-subtract"></use>
          </svg>
          <h4>icon-squares-subtract</h4>
        </li>
      
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-squares-unite"></use>
          </svg>
          <h4>icon-squares-unite</h4>
        </li>
      
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-squircle-dashed"></use>
          </svg>
          <h4>icon-squircle-dashed</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-truck-electric"></use>
          </svg>
          <h4>icon-truck-electric</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-user-lock"></use>
          </svg>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-wifi-cog"></use>
          </svg>
          <h4>icon-wifi-cog</h4>
        </li>
        ...
        <li class="symbol">
          <svg class="icon" aria-hidden="true">
            <use xlink:href="lucide.symbol.svg#icon-wifi-pen"></use>
          </svg>
          <h4>icon-wifi-pen</h4>
        </li>
